...
export function generateStaticParams() { return getAllProducts().map(p => ({ handle: p.Handle })); }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div>
          <div className="aspect-square w-full overflow-hidden rounded-2xl bg-gray-100">
            <Image src={`/images/${product.Handle}.jpg`} alt={product.Product_Name} width={1200} height={1200}
