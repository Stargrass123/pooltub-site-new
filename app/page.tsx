  ...
  return (
    <div className="max-w-3xl mx-auto p-6 py-20">
      ...
      <div className="mt-8 flex gap-3">
        <Link href="/products" className="rounded-xl bg-black text-white px-5 py-3 font-semibold">
          Shop
        </Link>
        <Link href="/calculator" className="rounded-xl border px-5 py-3 font-semibold">
          Savings Calculator
        </Link>
      </div>
    </div>
